...
import { V as VALID_INPUT_FORMATS, A as APP_BLOG, B as BLOG_BASE, C as CATEGORY_BASE, T as TAG_BASE, e as cleanSlug, P as POST_PERMALINK_PATTERN, t as trimSlash } from './consts_D7Wgx-c_.mjs';
import { A as AstroError, R as RenderUndefinedEntryError, c as createComponent, r as renderTemplate, u as unescapeHTML, U as UnknownContentCollectionError, f as renderUniqueStylesheet, g as renderScriptElement, h as createHeadAndContent, a as renderComponent } from './astro/server_DoRQTvF3.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_DrtBGr_4.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_SUPABASE_ANON_KEY": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imh2a210ZGt6em1ta3Bna3ZxY3Z3Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDE1ODMzNTAsImV4cCI6MjA1NzE1OTM1MH0.thu9omXC-2l0Iy_wH8aoQQCshU8iamPVdt3wBHpkAOQ", "PUBLIC_SUPABASE_URL": "https://hvkmtdkzzmmkpgkvqcvw.supabase.co", "SITE": "https://yourwebsite.com", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_B50PSraR.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_W65t8ljE.mjs');
