import { c as createComponent, r as renderTemplate, b as addAttribute, i as defineScriptVars, d as createAstro, a as renderComponent, u as unescapeHTML, F as Fragment, s as spreadAttributes, j as renderScript, k as renderHead, e as renderSlot } from './astro/server_DoRQTvF3.mjs';
import 'kleur/colors';
/* empty css                                 */
import { f as getAsset, U as UI, d as getCanonical, S as SITE, I as I18N, M as METADATA, h as ANALYTICS } from './consts_D7Wgx-c_.mjs';
import 'clsx';
import merge from 'lodash.merge';
import { escape } from 'html-escaper';
import { g as getImage } from './_astro_assets_B50PSraR.mjs';
...
}, "/workspaces/astrowind/src/components/common/CommonMeta.astro", undefined);

const favIcon = "/_astro/favicon.CGiRCjPI.ico";

const favIconSvg = new Proxy({"src":"/_astro/favicon.DdG4yz8P.svg","width":1024,"height":1024,"format":"svg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/workspaces/astrowind/src/assets/favicons/favicon.svg";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("/workspaces/astrowind/src/assets/favicons/favicon.svg");
							return target[name];
						}
					});
...
const appleTouchIcon = new Proxy({"src":"/_astro/apple-touch-icon.DHIlG7dp.png","width":180,"height":180,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/workspaces/astrowind/src/assets/favicons/apple-touch-icon.png";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("/workspaces/astrowind/src/assets/favicons/apple-touch-icon.png");
							return target[name];
						}
					});
...
}, "/workspaces/astrowind/src/components/Favicons.astro", undefined);
...
}, "/workspaces/astrowind/src/components/CustomStyles.astro", undefined);
...
}, "/workspaces/astrowind/src/components/common/ApplyColorMode.astro", undefined);
...
}, "/workspaces/astrowind/node_modules/@astrolib/seo/src/AstroSeo.astro", undefined);
...
const astroAsseetsOptimizer = async (image, breakpoints, _width, _height, format = undefined) => {
  if (!image) {
    return [];
  }
  return Promise.all(
...
const unpicOptimizer = async (image, breakpoints, width, height, format = undefined) => {
...
async function getImagesOptimized(image, {
  ...
  const srcset = (await transform(image, breakpoints, Number(width) || undefined, Number(height) || undefined, format)).map(({ src, width: width2 }) => `${src} ${width2}w`).join(", ");
  return {
...
const load = async function() {
  ...
  try {
    images = /* #__PURE__ */ Object.assign({"/src/assets/images/admissions-banner.png": () => import('./admissions-banner_CXN2CEyA.mjs'),"/src/assets/images/app-store.png": () => import('./app-store_CEMFRkd2.mjs'),"/src/assets/images/default.png": () => import('./default_BLsbynML.mjs'),"/src/assets/images/google-play.png": () => import('./google-play_C0YQY5xQ.mjs'),"/src/assets/images/hero-image.png": () => import('./hero-image_W7gv4KBL.mjs'),"/src/assets/images/khan-academy.png": () => import('./khan-academy_j09f2SaC.mjs'),"/src/assets/images/sabaq-foundation.png": () => import('./sabaq-foundation_DIZHwhVS.mjs'),"/src/assets/images/student-portal.png": () => import('./student-portal_-uRg6Umj.mjs')});
  } catch (error) {
  }
  return images;
};
...
}, "/workspaces/astrowind/src/components/common/Metadata.astro", undefined);
...
}, "/workspaces/astrowind/src/components/common/SiteVerification.astro", undefined);
...
}, "/workspaces/astrowind/node_modules/@astrolib/analytics/src/GoogleAnalytics.astro", undefined);
...
}, "/workspaces/astrowind/src/components/common/Analytics.astro", undefined);
...
}, "/workspaces/astrowind/src/components/common/BasicScripts.astro", undefined);
...
const $$ClientRouter = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<meta name="astro-view-transitions-enabled" content="true"><meta name="astro-view-transitions-fallback"${addAttribute(fallback, "content")}>${renderScript($$result, "/workspaces/astrowind/node_modules/astro/components/ClientRouter.astro?astro&type=script&index=0&lang.ts")}`;
}, "/workspaces/astrowind/node_modules/astro/components/ClientRouter.astro", undefined);
...
}, "/workspaces/astrowind/src/layouts/Layout.astro", undefined);
