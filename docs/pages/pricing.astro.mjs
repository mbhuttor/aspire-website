...
import { $ as $$Pricing$1 } from '../chunks/Pricing_B2_8BCIv.mjs';
...
}, "/workspaces/astrowind/src/pages/pricing.astro", undefined);

const $$file = "/workspaces/astrowind/src/pages/pricing.astro";
const $$url = "/pricing";
